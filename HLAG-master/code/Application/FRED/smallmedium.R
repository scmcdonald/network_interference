...
packagelist<-list("lattice", "Rcpp", "MASS","methods", "zoo", "stats","utils","grDevices",
                  "graphics","RcppArmadillo", "RcppEigen", "R.matlab", "here")
lapply(packagelist,checkpackage)

#### Source Functions ####
source(here("HLAG-master/code/Application/FRED", "mainfunctionsinR.R")) # Main Functions in R 
source(here("HLAG-master/code/Application/FRED", "factorfunctions.R")) # Functions for factor-based models
sourceCpp(here("HLAG-master/code/Application/FRED",'mainfunctionsinC.cpp')) # Main Functions in C
sourceCpp(here("HLAG-master/code/Application/FRED",'auxftc.cpp')) # Auxiliary Functions

#### Import the data ####
load(here("HLAG-master/code/Application/FRED","data_FRED_QD_current_all.RData"))
